...
const teamMembers = [
  {
    ...
    initials: "SLPL",
    github: "https://github.com/xamaseth",
    linkedin: "https://www.linkedin.com/in/seth-luxama-pierre-louis/",
    email: "pierrelouissethluxama@gmail.com",
  },
  {
    id: 2,
    name: "Belensky Lordé",
    ...
    github: "https://github.com/Bilylord",
    linkedin: "https://www.linkedin.com/in/belensky-lorde/",
    email: "lordebelens@gmail.com",
  },
  {
    id: 3,
...
const projects = [
  {
    ...
    title: "Okay Délice",
    description:
      "Site web pour restaurant de cuisine haïtienne authentique. Menu interactif, gestion des actualités, système d'authentification et espace client.",
    tech: ["HTML/CSS", "JavaScript", "Django", "SQLite"],
    placeholder: "🍽️",
    demo: "https://okaydelice.com/",
    github: null,
  },
  {
    id: 2,
    title: "ImagePlus Rent a Car",
    description:
      "Système de gestion pour location de véhicules. Gestion du fleet, réservations, suivi des paiements et administration. Nous avons participé au développement de ce projet.",
    placeholder: "🚗",
    demo: null,
    github: null,
  },
    ...
    <div class="project-card">
      ...
      <div class="project-content">
        ...
        <div class="project-links">
          ...
          ${project.demo
          ? `
            <a href="${project.demo}" class="project-link ${project.github ? "secondary" : "primary"}" target="_blank" rel="noopener noreferrer">
              ...
              ${project.github ? "Demo" : "Voir le site"}
            </a>
            `
          : ""
        }
